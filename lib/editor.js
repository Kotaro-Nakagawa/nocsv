...
class Editor {
  ...
  constructor(editorElement) {
    ...
    this.#display = new DisplayModelManager(() => { this.#displayReload() }, this.#canvas)
    this.#view = new ViewManager(this.#scrollManager, this.#model, this.#display)
    this.#controller = new ControllerManager(this.#display, this.#view, this.#model)
    this.#resetView()
  }
