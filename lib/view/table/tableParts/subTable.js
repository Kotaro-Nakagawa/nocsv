...
class SubTable extends NodeElement {
  constructor(data, columns, x, y, width, depth) {
    ...
    this._children = {
      title: new SubTitle(title, x + 24 + rowIndentSize, y, width - 24 - rowIndentSize, rowHeight),
      isFolding: new FoldingButton("", x + rowIndentSize, y, rowHeight, rowHeight, isFolding)
    }
