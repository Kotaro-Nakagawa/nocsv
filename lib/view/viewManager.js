...
class ViewManager {
  ...
  update(data) {
    this.#displayModel.resetCanvas()
    this.#tableList = new TableList(data, this.#displayModel.getBasePoint(), this.#displayModel.setting)
    this.#displayModel.setScrollBottom(this.#tableList.bottom)
